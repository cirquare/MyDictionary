    ...
    render() {
        ...
        return (
            <div className="container">
                <h1 className="Trans-title small-cha"><b>Information</b></h1>
            <div className="homepage-btn-crew">
                <Link to ={'/info'}><button type="button" disabled="disabled" className="btn btn-info homepage-btn">Info</button></Link> &nbsp;
